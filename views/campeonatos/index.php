...
/** @var app\models\CampeonatosSearch $searchModel */
...
<div class="campeonatos-index"> <!-- Clase para aplicar el estilo -->

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a(Yii::t('app', 'Create Campeonatos'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, Campeonatos $model, $key, $index, $column) {
                    return Url::toRoute([$action, 'titulo_id' => $model->titulo_id]);
                }
            ],
        ],
    ]); ?>
